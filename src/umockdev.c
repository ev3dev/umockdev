/* umockdev.c generated by valac 0.36.4, the Vala compiler
				...
				s = s_collection[s_it];
				{
					...
					if (_tmp33_ > 0) {
						...
						sock_path = NULL;
						{
							...
							GSocketAddress* _tmp44_;
							GUnixSocketAddress* _tmp45_;
							const gchar* _tmp46_;
							const gchar* _tmp47_;
							gchar* _tmp48_;
							gchar* script = NULL;
							...
							const gchar* _tmp63_;
							gint _tmp64_;
							UMockdevScriptRunner* _tmp65_;
							GHashTable* _tmp66_;
							const gchar* _tmp67_;
							gchar* _tmp68_;
							UMockdevScriptRunner* _tmp69_;
							_tmp42_ = s;
