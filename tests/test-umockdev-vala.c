/* test-umockdev-vala.c generated by valac 0.38.2, the Vala compiler
...
enum  {
	...
	ATTRIBUTE_COUNTER_THREAD_LAST_PROPERTY
};
static GParamSpec* attribute_counter_thread_properties[ATTRIBUTE_COUNTER_THREAD_LAST_PROPERTY];
...
void t_usbfs_ioctl_tree_with_default_device (void) {
	...
	gint _tmp20_;
	gint _tmp21_;
	struct usbdevfs_connectinfo _tmp22_;
	guint _tmp23_;
