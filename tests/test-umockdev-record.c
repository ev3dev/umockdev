...
void t_system_all (void) {
	...
	__catch2_umockdev_error:
	{
		...
		_inner_error_ = NULL;
		_tmp21_ = e->message;
		g_error ("test-umockdev-record.vala:224: Error when adding system dump to testbe" \
"d: %s", _tmp21_);
		_g_error_free0 (e);
	}
	__finally2:
...
void t_system_script_log_chatter (void) {
	...
	__catch9_g_spawn_error:
	{
		...
		_inner_error_ = NULL;
		_tmp30_ = e->message;
		g_error ("test-umockdev-record.vala:516: Cannot call umockdev-record: %s", _tmp30_);
		_g_error_free0 (e);
	}
	__finally9:
	if (_inner_error_ != NULL) {
...
void t_system_script_log_chatter_socket_stream (void) {
	...
	spath = _tmp0_;
	{
		...
		__catch11_g_spawn_error:
		{
			...
			_inner_error_ = NULL;
			_tmp36_ = e->message;
			g_error ("test-umockdev-record.vala:595: Cannot call umockdev-record: %s", _tmp36_);
			_g_error_free0 (e);
		}
		__finally11:
		if (_inner_error_ != NULL) {
	...
	__catch10_g_error:
	{
		...
		g_remove (_tmp80_);
		_tmp81_ = e->message;
		g_error ("test-umockdev-record.vala:646: Error: %s", _tmp81_);
		_g_error_free0 (e);
	}
	__finally10:
	if (_inner_error_ != NULL) {
...
void t_gphoto2_record (void) {
	...
	__catch14_g_regex_error:
	{
		...
		_inner_error_ = NULL;
		_tmp18_ = e->message;
		g_error ("test-umockdev-record.vala:771: Internal error building regex: %s", _tmp18_);
		_g_error_free0 (e);
	}
	__finally14:
	if (_inner_error_ != NULL) {
