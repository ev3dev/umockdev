/* test-umockdev-record.c generated by valac 0.30.1, the Vala compiler
...
void t_system_single (void) {
	...
	_tmp4_ = g_strconcat (_tmp3_, " /dev/null /dev/zero", NULL);
	_tmp5_ = _tmp4_;
	...
	_tmp11_ = sout;
	assert_in ("E: DEVNAME=/dev/null", _tmp11_);
	_tmp12_ = sout;
	assert_in ("P: /devices/virtual/mem/null", _tmp12_);
	_tmp13_ = sout;
	assert_in ("E: DEVNAME=/dev/zero", _tmp13_);
	_g_free0 (serr);
	_g_free0 (sout);
}
