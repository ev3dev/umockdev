/* test-umockdev-record.c generated by valac 0.22.0, the Vala compiler
...
void t_system_script_log_chatter (void) {
	...
	__catch6_g_spawn_error:
	{
		...
		_inner_error_ = NULL;
		_tmp30_ = e->message;
		g_error ("test-umockdev-record.vala:392: Cannot call umockdev-record: %s", _tmp30_);
		_g_error_free0 (e);
	}
	__finally6:
	if (_inner_error_ != NULL) {
...
void t_system_script_log_chatter_socket_stream (void) {
	...
	spath = _tmp0_;
	{
		...
		__catch8_g_spawn_error:
		{
			...
			_inner_error_ = NULL;
			_tmp36_ = e->message;
			g_error ("test-umockdev-record.vala:468: Cannot call umockdev-record: %s", _tmp36_);
			_g_error_free0 (e);
		}
		__finally8:
		if (_inner_error_ != NULL) {
	...
	__catch7_g_error:
	{
		...
		g_remove (_tmp79_);
		_tmp80_ = e->message;
		g_error ("test-umockdev-record.vala:519: Error: %s", _tmp80_);
		_g_error_free0 (e);
	}
	__finally7:
	if (_inner_error_ != NULL) {
...
void t_gphoto2_record (void) {
	...
	__catch10_g_regex_error:
	{
		...
		_inner_error_ = NULL;
		_tmp16_ = e->message;
		g_error ("test-umockdev-record.vala:584: Internal error building regex: %s", _tmp16_);
		_g_error_free0 (e);
	}
	__finally10:
	if (_inner_error_ != NULL) {
